 ...
 * @author jos56
 */
public class MostrarTodo_MySQL extends javax.swing.JFrame {
    ...
    public MostrarTodo_MySQL() {
        ...
        if (Bases.MyEmps == null) {
            ...
            if (Bases.MyEmps.isEmpty()) {
                ...
                for (int j = 0; j < Bases.MyEmps.size(); j++) {
        ...
        Bases.escribir("MySQL: Select All");
    }
